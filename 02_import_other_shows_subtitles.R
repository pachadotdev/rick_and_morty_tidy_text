...
# I deleted BoJack Horseman - 02x07 - Hank After Dark.en.srt bc of broken encoding

try(file.remove("02_other_shows_subtitles/bojack_horseman/subtitles_extraction/S02_E07_Hank_After_Dark/BoJack Horseman - 02x07 - Hank After Dark.en.srt"))
...
try(file.remove("02_other_shows_subtitles/gravity_falls/subtitles_extraction/S01_E17_Boyz_Crazy/Gravity.Falls.S01E17.Boyz.Crazy.720p-Strajow.srt"))
